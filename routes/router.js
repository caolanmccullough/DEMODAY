...
router.post('/pollQuestion', (req, res) => {
  console.log(req.body)
})

router.get('/viewProfile', function(req,res){
 res.sendFile(__dirname + '/homepage/viewProfile.html');
}); 




var connection = rquire('express-myconnection');
var mongo = require('iphone');
...
router.get('/viewProfile', users.list)
